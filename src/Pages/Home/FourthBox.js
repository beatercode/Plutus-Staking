...
import { stake4_address, stake2_3_abi, token_abi, Stake4_token_Address } from "../../components/config";
      ...
      <div className="body-bottom flex flex-col w-full">
        ...
        <div className={`expend-detail flex flex-col ${expend ? "show" : ""}`}>
          ...
          <div className="detail-item flex items-center justify-between">
            <div className="lbl-side"></div>
            <div className="val-side">
              <a href={"https://scan.pulsechain.com/address/" + stake4_address} target="_blank" className="sub-menu-item" style={{ color: "#2498A3" }}>
                View Contract
              </a>
            </div>
          </div>
    ...
    <div className="grid-box flex flex-col">
      <div className="box-header flex items-center">
        {headerTabsList.map((item, index) => (
          <div
            key={index}
            className={`header-item flex items-center justify-center ${(selectedTab3 === item.title) & (boxNumb === 4) ? "active" : ""}`}
            onClick={(e) => {
              ...
              <div className="input-form flex flex-col">
                <div className="input-field flex flex-col">
                  <div className="field-hdr flex items-center justify-between">
                    ...
                    <h1 className="f-tag">
                      Balance: <span className="font-semibold">{data ? (Number(data[8].result) / 10 ** 18).toFixed(2) : 0} WBTC</span>
                    </h1>
                  </div>
